...
try:
    os.mkdir("Models/MA_HE")
except Exception as e:
    print(e)

# Features

df = pd.read_csv("featuressssssss_3/train_fetures_extraction_MA_HE.csv")
df_test = pd.read_csv("featuressssssss_3/test_fetures_extraction_MA_HE.csv")
print(df.head())
print(df_test.head())
print(df.shape)
print(df_test.shape)
...
df_he = df_train[df_train["Label"] == "HE"]
df_ma = df_train[df_train["Label"] == "MA"]
df_none = df_train[df_train["Label"] == "NONE"].sample(10000)
...
scalar_filename = "Models/MA_HE/balanced_loss_ss.save"
joblib.dump(ss, scalar_filename)

# All models use a balanced loss
...
model_filename = "Models/MA_HE/balanced_loss_lr.save"
...
model_filename = "Models/MA_HE/balanced_loss_svc.save"
joblib.dump(model, model_filename) 
...
model_filename = "Models/MA_HE/balanced_loss_rf.save"
joblib.dump(model, model_filename) 
