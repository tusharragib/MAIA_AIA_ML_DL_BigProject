...
def feature_extraction(orig_path, CAND, label_1, label_2, labels = ["MA", "HE"]):
...
pathFolder_handCrafted = 'E:/Academic/MAIA/Semester_2/Main/ML_DL_AIA Project_Final/New Candidates/MA-HE/MA-HE_Training/'
pathFolderSE = 'E:/Academic/MAIA/Semester_2/Main/ML_DL_AIA Project_Final/GT/training/microaneurysms/'
pathFolderEX = 'E:/Academic/MAIA/Semester_2/Main/ML_DL_AIA Project_Final/GT/training/haemorrhages/'
...
for file_name in filesArray:
    ...
    print(file_name)
    print(pathFolderEX +file_name_no_extension+"_HE.tif")
    print(pathFolderSE +file_name_no_extension+"_MA.tif")      
    print(pathFolder_handCrafted + file_name_no_extension + '_MA-HE final result.png')
    print(pathFolder_handCrafted + "MA-HE final result_" + file_name_no_extension.split("_")[1] + ".png")
    print(pathFolder_handCrafted + file_name_no_extension + "_MA-HE final result.png")

    
    features = feature_extraction(pathFolder +'/'+ file_name, 
                                  pathFolder_handCrafted + file_name_no_extension + "_MA-HE final result.png", 
                                  pathFolderSE +file_name_no_extension+"_MA.tif", 
                                  pathFolderEX +file_name_no_extension+"_HE.tif")
    print(file_name)
    ...
    #             "feature_har_1": j[1][5], "feature_har_2": j[1][6], "feature_har_3": j[1][7], "feature_har_4": j[1][8], "feature_har_5": j[1][9], 
    #             "feature_har_6": j[1][10], "feature_har_7": j[1][11], "feature_har_8": j[1][12], "feature_har_9": j[1][13], "feature_har_10": j[1][14], 
    #             "feature_har_11": j[1][15], "feature_har_12": j[1][16], "feature_har_13": j[1][17]}, ignore_index = True)
...
df.to_csv('featuressssssss_3/train_fetures_extraction_MA_HE.csv', index = False)
