...
df_he = df_train[df_train["Label"] == "SE"]
df_ma = df_train[df_train["Label"] == "EX"]
...
scalar_filename = "Models/SE_EX/balanced_loss_ss.save"
...
model_filename = "Models/SE_EX/balanced_loss_lr.save"
...
model_filename = "Models/SE_EX/balanced_loss_svc.save"
joblib.dump(model, model_filename) 
...
model_filename = "Models/SE_EX/balanced_loss_rf.save"
joblib.dump(model, model_filename) 
