...
n_ma = df_train[df_train["Label"] == "MA"].shape[0]

df_he = df_train[df_train["Label"] == "HE"].sample(n_ma)
df_ma = df_train[df_train["Label"] == "MA"].sample(n_ma)
...
scalar_filename = "Models/MA_HE/balanced_data_ss.save"
...
model_filename = "Models/MA_HE/balanced_data_lr.save"
...
model_filename = "Models/MA_HE/balanced_data_svc.save"
joblib.dump(model, model_filename) 
...
model_filename = "Models/MA_HE/balanced_data_rf.save"
joblib.dump(model, model_filename) 
